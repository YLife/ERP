...
<form action="DoTaskAddServlet" method="post" name="fom" id="fom" target="sypost" >
<div class="MainDiv">
			...
			<TD width="100%">
				...
				<legend>添加任务</legend>
					  ...
					  <tr>
					    ...
					    <td width="41%"><input name="taskName" class="text" style="width:250px" type="text" size="40" />
				...
				<select name="funId" >
					...
					<c:forEach items="${list5 }" var="fun">
					  ...
					  <tr>
					    ...
					    <td><input name="createDate" type="text" id="" class="text" style="width:154px"/></td>
					    <td align="right">计划结束时间:</td>
					    <td><input name="endDate" type="text" id="Input" class="text" style="width:154px" /></td>
					  </tr>
					   <tr>
					  ...
					  <tr>
					    ...
					    <td colspan="3"><textarea id="textarea" name="taskNote" rows="5" cols="80"></textarea></td>
					    </tr>
					  </table>
			 <br />
				</fieldset>			</TD>
