...
<body>
<form action="DoEmpRegisterServlet" method="post">
        ...
        <tr>
          <td background="user2/images/register_28.gif"><form id="form1" name="form1" method="post" action="">
              ...
              <tr>
                <td align="center"><table width="272" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="left"><input id="yhxm" type="text" dataType="Limit" require="true" msg="用户姓名不能为空"  name="empName"/></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td align="left"><input id="checkmm" size="25" type="password" dataType="Limit" require="true" msg="确认密码不能为空" name="empPwd"/></td>
                  </tr>
                </table></td>
			...
			<td width="201">&nbsp;</td>
                        ...
                        <td width="62"><input onclick="window.history.go(-1);" type="image" src="user2/images/rr_24.gif" width="62" height="23"></td>
			<td width="201">&nbsp;</td>
                      </tr>
                    </table>
