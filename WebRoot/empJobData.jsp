			...
			<TD width="100%">
				...
				<legend>职位信息</legend>
					  ...
					  <tr>
					    ...
					    <td width="27%"><input name='txt3' type="text" class="text" style="width:154px" value="${empJob.jobName }" disabled="disabled"/>	
					  ...
					  <tr>
					    ...
					    <td colspan="3"><select name="select1"  disabled="disabled">
							<option>低级</option>
